...
import { CreateFoodInput, CreateOfferInputs, EditVandorInput, VandorLoginInput } from '../dto'
import { Food, Offer, Order, Vandor } from '../models';
import { GenerateSignature, PasswordValidate } from '../utility'
...
export const Addfood = async (req: Request, res: Response, next: NextFunction) => {
    const user = req.user;
    const { name, description, category, foodTypes, readyTime, price } = <CreateFoodInput>req.body;
